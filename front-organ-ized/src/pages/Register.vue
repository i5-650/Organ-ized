        ...
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form @submit.prevent="register" class="login100-form validate-form">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Enter your firstname">
                      <input v-model="fname" class="input100" type="text" name="fname" placeholder="John">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Enter your lastname">
                      <input v-model="lname" class="input100" type="text" name="lname" placeholder="Doe">
                      <span class="focus-input100"></span>
                      <span class="symbol-input100">
                        <i class="fa fa-envelope" aria-hidden="true"></i>
                      </span>
